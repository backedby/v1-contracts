...
def test_multiTierSubscribe(je_org):
    ...
    prepaidGas = je_org.subscriptions[je_org.TUSD.address].getSubscriptionGasRequirement()
...
def test_changeCurrency(je_org):
    ...
    prepaidGas = je_org.subscriptions[je_org.DAI.address].getSubscriptionGasRequirement()
    with reverts():
