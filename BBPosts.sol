...
contract BBPosts is IBBPosts {
    ...
    /*
        ...
        @param Post CID
    */
    function createPost(uint256 profileId, string memory cid) external override returns(uint256 postId){
    ...
    /*
        ...
        @param New post CID
    */
    function editPost(uint256 profileId, uint postId, string memory cid) external override {
        (address profileOwner,,) = _bbProfiles.getProfile(profileId);
        require(profileOwner == msg.sender, BBErrorCodesV01.NOT_OWNER);
